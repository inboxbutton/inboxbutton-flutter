...
import 'package:inboxbutton_flutter_app/extensions.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: Builder(
        builder: (context) => InboxButtonTheme(
          data: theme,
          child: Scaffold(
            appBar: AppBar(
              ...
              actions: [
                ...
                IconButton(
                  ...
                  onPressed: () {
                    InboxButtonSdk.instance.startInboxButtonApp(context);
                  },
                ),
              ],
            ),
      ...
      builder: (context, child) {
        return InboxButtonTheme(data: theme, child: child ?? Container());
      },
    );
  }
}
